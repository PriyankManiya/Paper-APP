                                                      ...
                                                      onTap: () async {
                                                        // print("Follow Part");
                                                         if (money_controller
                                                              ...
                                                              money_controller.update();
                                                      },
                                                      child: money_controller
                                                                    .localList
                                                                    .value
                                                                    .value[0]
                                                                    .subCards[index]
                                            ...
                                            child: GetBuilder(
                                                ...
                                                builder: (_) {
                                                  return InkWell(
                                                    onTap: () async {
                                                      // print(
                                                      //     "Like : ${money_controller.localList.value.value[0].subCards[index].like}");
                                                    ...
                                                    child: Row(
                                                      ...
                                                      money_controller.update();
                                                        ...
                                                        money_controller
                                                                ...
                                                                .like
                                                            ? Text(
                                                                "${money_controller.localList.value.value[0].subCards[index].totallike}",
                                                                style: TextStyle(
                                                                    color: ColorTheme
                                                                        .btnshade2,
                                                                    fontWeight:
