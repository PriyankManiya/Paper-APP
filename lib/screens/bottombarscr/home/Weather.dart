...
class WeatherScreen extends StatefulWidget {
  String topic;
  WeatherScreen({Key key, this.topic}) : super(key: key);
  @override
...
FollowController followController = Get.put(FollowController());
  ...
  void _onLoading() async {
    ...
    await weather_controller.fetchMarketnews(
        page: pagination,
        topic: widget.topic,
        nextUrl: weather_controller.localList.value.value[0].nextPageUrl
        );
    await _streamController.add(weather_controller.localList.value);
    await Future.delayed(Duration(milliseconds: 1000));
    if (mounted)
      setState(() {
        pagination++;
  ...
  void getnewsdata() async {
    ...
    _streamController.add(weather_controller.localList.value);
  }
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return weather_controller.isLoading.value
          ? Container(
              child: Column(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  ...
                                  return InkWell(
                                    onTap: () {
                                      Get.to(
                                          () => NewsDetails(
                                              subCard: weather_controller.localList.value
                                      ...
                                      child: Column(
                                        children: [
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    sizedboxwidth(context, 50),
                                                   Text(
                                                      timeago.format(weather_controller
                                                          .localList
                                                          .value
                                                          .value[0]
                                                          .subCards[index]
                                            ...
                                            child: GetBuilder(
                                                ...
                                                builder: (_) {
                                                  return InkWell(
                                                    onTap: () async {
                                                      // print(
                                                      //     "Like : ${weather_controller.localList.value.value[0].subCards[index].like}");
                                          ...
                                          transition: Transition.cupertino);
                                                        ...
                                                        GestureDetector(
                                                          onTap: () {
                                                            Share.share(weather_controller
                                                  .localList
                                                  .value
                                                  .value[0]
