...
class LocalScreen extends StatefulWidget {
  String topic;
  LocalScreen({Key key, this.topic}) : super(key: key);
  @override
...
FollowController followController = Get.put(FollowController());
  ...
  void _onRefresh() async {
    // await local_controller.fetchMarketnews(page: 1);
  ...
  void _onLoading() async {
    ...
    await local_controller.fetchMarketnews(
        page: pagination,
        topic: widget.topic,
        nextUrl: local_controller.localList.value.value[0].nextPageUrl
        );
    await _streamController.add(local_controller.localList.value);
    await Future.delayed(Duration(milliseconds: 1000));
    if (mounted)
      setState(() {
        pagination++;
  ...
  void getnewsdata() async {
    ...
    _streamController.add(local_controller.localList.value);
  }
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return local_controller.isLoading.value
          ? Container(
              child: Column(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  ...
                                  return InkWell(
                                    onTap: () {
                                      Get.to(
                                          () => NewsDetails(
                                              subCard: local_controller.localList.value
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    sizedboxwidth(context, 50),
                                                   Text(
                                                      timeago.format(local_controller
                                                          .localList
                                                          .value
                                                          .value[0]
                                                          .subCards[index]
                                            ...
                                            child: GetBuilder(
                                                ...
                                                builder: (_) {
                                                  return InkWell(
                                                    onTap: () async {
                                                      // print(
                                                      //     "Like : ${local_controller.localList.value.value[0].subCards[index].like}");
                                                    ...
                                                    child: Row(
                                                      ...
                                                      local_controller.update();
                                                        ...
                                                        local_controller
                                                                ...
                                                                .like
                                                            ? Text(
                                                                "${local_controller.localList.value.value[0].subCards[index].totallike}",
                                                                style: TextStyle(
                                                                    color: ColorTheme
                                                                        .btnshade2,
                                                                    fontWeight:
