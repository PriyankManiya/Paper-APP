...
class SportScreen extends StatefulWidget {
  String topic;
  SportScreen({Key key, this.topic}) : super(key: key);
  @override
...
class _SportScreenState extends State<SportScreen> {
  ...
  void _onRefresh() async {
    // await headline_controller.fetchMarketnews(page: 1);
  ...
  void _onLoading() async {
    ...
    await sports_controller.fetchMarketnews(
        page: pagination,
        topic: widget.topic,
        nextUrl: sports_controller.localList.value.value[0].nextPageUrl
        );
    await _streamController.add(sports_controller.localList.value);
    await Future.delayed(Duration(milliseconds: 1000));
    if (mounted)
      setState(() {
        pagination++;
  ...
  void getnewsdata() async {
    ...
    _streamController.add(sports_controller.localList.value);
  }
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return sports_controller.isLoading.value
          ? Container(
              child: Column(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                return InkWell(
                                  onTap: () {
                                    Get.to(
                                        () => NewsDetails(
                                            subCard: sports_controller.localList.value
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  sizedboxwidth(context, 50),
                                                  Text(
                                                    timeago.format(sports_controller
                                                        .localList
                                                        .value
                                                        .value[0]
                                                        .subCards[index]
                                                    ...
                                                    //like
                                                     sports_controller
                                                      ...
                                                      sports_controller
                                                              ...
                                                              .like
                                                          ? Text(
                                                              "${sports_controller.localList.value.value[0].subCards[index].totallike}",
                                                              style: TextStyle(
                                                                  color: ColorTheme
                                                                      .btnshade2,
                                                                  fontWeight:
